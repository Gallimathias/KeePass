    ...
    public static class StrUtil
    {
        ...
        public static int CompareNaturally(string strX, string strY)
        {
            ...
            while ((pX < cX) && (pY < cY))
            {
                ...
                string strPartX = strX[pX..pExclX];
                string strPartY = strY[pY..pExclY];
            ...
            bool bCaseSensitive)
        {
            ...
            while (true)
            {
                ...
                str = str[(minIndex + vSeps[minSep].Length)..];
            }
        ...
        public static bool IsDataUri(string strUri, string strReqMediaType)
        {
            ...
            if (!string.IsNullOrEmpty(strReqMediaType))
            {
                ...
                string strMedia = strUri[strPrefix.Length..iTerm];
        ...
        public static byte[] DataUriToData(string strDataUri)
        {
            ...
            string strDesc = strDataUri[5..iSep];
            bool bBase64 = strDesc.EndsWith(";base64", CaseIgnoreCmp);

            string strData = strDataUri[(iSep + 1)..];
        ...
        public static string RemovePlaceholders(string str)
        {
            ...
            while (true)
            {
                ...
                str = (str.Substring(0, iPlhStart) + str[(iPlhEnd + 1)..]);
            }
