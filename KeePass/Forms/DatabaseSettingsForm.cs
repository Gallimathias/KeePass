...
namespace KeePass.Forms
{
    public partial class DatabaseSettingsForm : Form
    {
        ...
        private readonly List<ColorMenuItem> m_vColorItems = new();
        private Image m_imgColor = null;

        private readonly string m_strAutoCreateNew = "(" + KPRes.AutoCreateNew + ")";
        private readonly Dictionary<int, PwUuid> m_dictRecycleBinGroups = new();

        private readonly Dictionary<int, PwUuid> m_dictEntryTemplateGroups = new();

        private bool m_bInitializing = true;
        private volatile Task m_thKdf = null;
        ...
        private void OnBtnKdf1Sec(object sender, EventArgs e)
        {
            ...
            try
            {
                m_thKdf = new Task(() => Kdf1SecTh(null));
